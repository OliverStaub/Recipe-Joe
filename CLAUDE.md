...
### Running Tests
Use Xcode or xcodebuild to run tests:
- Xcode: Product > Test (Cmd+U)
- Command line: `xcodebuild test -project RecipeJoe.xcodeproj -scheme RecipeJoe -destination 'platform=iOS Simulator,name=iPhone 16,OS=latest'`
